...
public class C0619_04 {
	...
	public static void main(String[] args) {
		// 퀴즈
		// 5,5 배열을 생성해서 1,1,1,1,1 나머지는 0으로 채워서
		// 랜덤으로 섞어서 출력
		...
		while(true) {
			...
			// 입력받은 좌표값이 확인이 된 좌표이면 확인이 된 좌표입니다.
			// 라고 출력이 되고, 다시 입력받게 해주세요.
			// String
			if(x<0 || x>=5 || y<0 || y>=5) {
			...
			if(lotto[x][y].equals("꽝") || lotto[x][y].equals("당첨")) {
				System.out.println("확인된 좌표입니다. 다시 입력해주세요.");
				System.out.println();
				continue;
		}
				
			// 5. arr 배열에서 x,y의 좌표 값을 비교
